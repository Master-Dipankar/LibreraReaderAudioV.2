...
public abstract class GeometryLineObjectIntersection2D<G1 extends GeometryLineObject2D, G2 extends GeometryLineObject2D, P extends GeometryPointObject2D, L extends GeometryLineObject2D>
        extends GeometryIntersection2D<G1, G2, P, L, GeometryAreaObject2D> {
    
    public GeometryLineObjectIntersection2D(G1 geometryLineObject1,
